...
| <a name="input_zones"></a> [zones](#input\_zones) | (Optional) - Yandex Cloud Zones for provisoned resources. | `set(string)` | <pre>[<br/>  "ru-central1-a",<br/>  "ru-central1-b",<br/>  "ru-central1-d"<br/>]</pre> | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_access_key"></a> [access\_key](#output\_access\_key) | The static access key of the s3 bucket service account. |
| <a name="output_all_subnets"></a> [all\_subnets](#output\_all\_subnets) | The list of all subnets. |
...
| <a name="output_secret_key"></a> [secret\_key](#output\_secret\_key) | The static secret key of the s3 bucket service account. |
